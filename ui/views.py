...
def print_help() -> None:
    commands = [
        ...
        ("/model",          "Show/change LLM routing"),
        ("/status",         "Show system status + provider health"),
        ("/chat",           "Open free-form chat"),
        ("/help",           "Show this help"),
    ]
